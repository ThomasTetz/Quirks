...
public class TradeDetailItemAdapter extends BaseAdapter implements ListAdapter {

    private ArrayList<Drop> list = new ArrayList<>();
    private Context context;

    public TradeDetailItemAdapter(ArrayList<Drop> list, Context context) {
        this.list = list;
    ...
    public View getView(final int pos, View convertView, ViewGroup viewGroup) {
        ...
        collectibleBox.setVisibility(View.INVISIBLE);
